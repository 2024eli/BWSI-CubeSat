...
def animate(i, xs, type,y1,y2,y3, mag_offset, gyro_offset, initial_angle):
    ...
    if type == 'am':
       ...
       y3.append(yaw_am(accelX,accelY,accelZ,magX,magY,magZ, zeroCalib))
       ax.clear()
...
def plot_data(type = 'am'):
    ...
    ani = animation.FuncAnimation(fig, animate, fargs =(xs,type,y1,y2,y3,mag_offset,gyro_offset,initial_angle), interval = 500)
    plt.show()
