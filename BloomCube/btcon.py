...
class BTCon:
    ...
    def connect_as_host(self, port): #TODO change this to dynamic
        ...
        print("Set as discoverable at " + time.ctime())
    ...
    def connect_as_client(self, port): #TODO change to dynamic
        ...
        for addr in nearby_devices:
            ...
            if self.other_name == bluetooth.lookup_name(addr) or bluetooth.lookup_name(addr) == None:
    ...
    #     connect_as_host(port)
    #     connect_as_client(port)
    ...
    def receive_string(self):
        ...
        data = self.client_sock_receive.recv(1024)
